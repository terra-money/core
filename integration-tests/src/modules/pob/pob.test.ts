...
describe("Proposer Builder Module (https://github.com/skip-mev/pob) ", () => {
    ...
    const wallet = LCD.chain1.wallet(accounts.mnemonic1);
    const wallet11 = LCD.chain1.wallet(accounts.mnemonic11);
    ...
    test('Must create and order two transactions in block', async () => {
        ...
        const firstMsg = MsgSend.fromData({
            ...
            "from_address": accounts.mnemonic1.accAddress("terra"),
            "to_address": accounts.mnemonic11.accAddress("terra"),
        ...
        let buildTx = await wallet11.createAndSignTx({
            msgs: [MsgAuctionBid.fromData({
                ...
                bidder: accounts.mnemonic11.accAddress("terra"),
