...
func initTestnetFiles(
	...
	for i := 0; i < args.numValidators; i++ {
		...
		coin := sdk.NewCoin(config.BondDenom, math.NewInt(1_000_000_000_000))
		genBalances = append(genBalances, banktypes.Balance{Address: addr.String(), Coins: sdk.NewCoins(coin)})
...
func initGenFiles(
	...
	appGenState := terraapp.GenesisState(mbm.DefaultGenesis(clientCtx.Codec)).
		SetDefaultTerraConfig(clientCtx.Codec)
...
func collectGenFiles(
	...
	for i := 0; i < numValidators; i++ {
		...
		nodeAppState, err := genutil.GenAppStateFromConfig(clientCtx.Codec, clientCtx.TxConfig, nodeConfig, initCfg, *genDoc, banktypes.GenesisBalancesIterator{}, genutiltypes.DefaultMessageValidator)
		if err != nil {
			return err
		}
